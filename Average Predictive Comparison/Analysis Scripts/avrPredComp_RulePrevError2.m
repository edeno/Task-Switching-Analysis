function [avpred] = avrPredComp_RulePrevError2(session_name, timePeriod, model_name, numSim, numSamples, save_folder, main_dir)
...
for rep_id = 1:10,
    ...
    orientationCov(prev_error_ind).data(:, rep_id) = 2;
    ...
    colorCov(prev_error_ind).data(:, rep_id) = 2;
