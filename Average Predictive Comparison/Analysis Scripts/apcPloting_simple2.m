...
load('RuleBy_TimePeriods_data.mat');
%%
...
for brain_ind = 1:2,
    for curTimePeriod_ind = 1:length(timePeriods);
        for rule_ind = [1 3],
            ...
            mean_switch = [mean_ruleByAPC{curTimePeriod_ind, switch_hist_ind, brain_ind, rule_ind}];
            
            ci_switch = [ci_ruleByAPC{curTimePeriod_ind, switch_hist_ind, brain_ind, rule_ind, :}]';
