#!/bin/sh
modelList[0]="s(Previous Error, Trial Time, knotDiff=50) + s(Response Direction, Trial Time, knotDiff=50) + s(Rule, Trial Time, knotDiff=50)"
...
modelList[2]="s(Rule \* Previous Error, Trial Time, knotDiff=50) + s(Response Direction, Trial Time, knotDiff=50) + s(Rule \* Rule Repetition, Trial Time, knotDiff=50) + s(Rule \* Congruency, Trial Time, knotDiff=50)"
