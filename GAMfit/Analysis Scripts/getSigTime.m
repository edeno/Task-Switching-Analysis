...
for level_ind = 1:numLevels,
    ...
    simMeanEst = mvnrnd(neuron.parEst(getMeanLevel(levelsOfInterest{level_ind})), stat.covb(getMeanLevel(levelsOfInterest{level_ind}), getMeanLevel(levelsOfInterest{level_ind})), numSim)';
