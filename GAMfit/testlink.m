function [link,dlink,ilink] = testlink(linkArg,dataClass)
%STATTESTLINK Test link function for GLMFIT and GLMVAL

%   Copyright 1993-2011 The MathWorks, Inc.
%   $Revision: 1.1.6.3 $  $Date: 2011/09/19 18:13:25 $
...
if isstruct(linkArg)
    ...
    if ~all(ismember(fieldsNeeded, fieldsFound))
        error('stats:stattestlink:MissingFields',...
              'Some required fields are missing from the link structure.');
    end
