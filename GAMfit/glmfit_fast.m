function [bb,dev,stats] = glmfit_fast(x,y,distr,varargin)
%GLMFIT_FAST Fit a generalized linear model. Differs from normal glmfit function
%   by having a lesser number of maximum iterations for the IRLS algorithm
%   (40).
%
...
[anybad,wasnan,y,x,offset,pwts,N] = removeNaN_temp(y,x,offset,pwts,N);
if anybad > 0
    switch anybad
    case 2
