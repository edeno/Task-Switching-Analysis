...
main = 'convertSpikeFile_toJSON_standalone'; % or myApp if not to use myStandalone
                       % Then, place myApp.m in current folder

%%2 Location of the rest of your m-files
srcFolder = sprintf('%s/Helper-Functions/convertSpikeFile/ComputeConvertSpikeFile', main_dir); % more files to compile live here

%%3 Your executable base name
exec = 'computeConvertSpikeFileExec';   % MATLAB release appended later
