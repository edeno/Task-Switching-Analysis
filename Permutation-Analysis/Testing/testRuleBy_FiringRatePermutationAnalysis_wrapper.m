function [saveDir, p, obsDiff, randDiff] = testRuleBy_FiringRatePermutationAnalysis_wrapper(covariateOfInterest, Rate, varargin)
...
profile -memory on;
[saveDir, p, obsDiff, randDiff] = RuleBy_firingRatePermutationAnalysis('test', permutationParams, covInfo);
profile viewer;
