        ...
        for file_ind = 1:length(fileNames),
            ...
            for neuron_ind = 1:length(file.neuronNames)
                ...
                if ~permAnalysis.isKey(curNeuron),
                    ...
                    s.obsTimePeriod = repmat(timePeriods(time_ind), [length(file.obs(:, neuron_ind)), 1]);
                    ...
                    s.obsTimePeriod = [s.obsTimePeriod; repmat(timePeriods(time_ind), [length(file.obs(:, neuron_ind)), 1])];
