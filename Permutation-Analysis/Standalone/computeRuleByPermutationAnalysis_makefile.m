...
main = 'computeRuleByPermutationAnalysis_standalone'; % or myApp if not to use myStandalone
                       % Then, place myApp.m in current folder

%%2 Location of the rest of your m-files
srcFolder = sprintf('%s/Permutation-Analysis/ComputePermutationAnalysis/', main_dir); % more files to compile live here

%%3 Your executable base name
exec = 'computeRuleByPermutationAnalysisExec';   % MATLAB release appended later
...
credit = '-R ''-startmsg,Program authored by Eric Denovellis''';
