...
vline(obs_small);
title(sprintf('p-value: %.2f', p_small));
subplot(3,2,2);
hist(randDiff_large, 50);
vline(obs_large);
title(sprintf('p-value: %.2f', p_large));
subplot(3,2,3);
hist(randDiff_wrong(1,:), 50);
vline(obs_wrong(1));
title(sprintf('p-value: %.2f', p_wrong(1)));
subplot(3,2,4);
hist(randDiff_wrong(2,:), 50);
vline(obs_wrong(2));
title(sprintf('p-value: %.2f', p_wrong(2)));
subplot(3,2,5);
hist(randDiff_wrong(3,:), 50);
vline(obs_wrong(3));
title(sprintf('p-value: %.2f', p_wrong(3)));
subplot(3,2,6);
hist(squeeze(randDiff_wrong(4,:)), 50);
vline(obs_wrong(4));
title(sprintf('p-value: %.2f', p_wrong(4)));